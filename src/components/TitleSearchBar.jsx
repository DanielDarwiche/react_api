...
const TitleSearchBar = ({titleSetResults}) => {
...
const fetchData = (value)=> {
 ...
 //arrayfunction called filter...goes through each element in array
        ...
        const results= books.result.filter((bok)=>{
            return value && bok && bok.title && bok.title.toLowerCase().includes(value);
        })
        titleSetResults(results);
        console.log(books );
...
const handleChange= (value)=>{
  ...
  return (
    <div className="input-wrapper">
        <i class="bi bi-file-text-fill"><b> Search books by 'Title'</b>&nbsp;&emsp;&emsp;</i>
        <input 
        placeholder=" ..."
        value={input} 
